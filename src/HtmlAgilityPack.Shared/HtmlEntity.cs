...
namespace HtmlAgilityPack
{
    ...
    /// 用实体替换特殊字符的实用程序类，反之亦然。
    /// HTML 4.0规范可在http://www.w3.org/TR/html4/sgml/entities.html找到
    /// 以下附加规范可在https://en.wikipedia.org/wiki/List_of_XML_and_HTML_character_entity_references找到
    ...
    public class HtmlEntity
    {
        ...
        /// 克隆并实体化一个HtmlNode。这将影响属性值和节点的文本。它还将实体化所有子节点。
        /// </summary>
        ...
        /// 如果设置为false，函数将不会使用已知的实体名。默认是正确的。
        /// </param>
        /// <returns>The result text.</returns>
        ...
        /// 如果设置为true， [quote]，[ampersand]，[小于]和[大于]字符将被实体化。
        /// </param>
        /// <returns>The result text</returns>
